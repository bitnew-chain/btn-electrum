...
import btn_electrum
from btn_electrum.bitcoin import TYPE_ADDRESS
from btn_electrum import WalletStorage, Wallet
from btn_electrum_gui.kivy.i18n import _
from btn_electrum.paymentrequest import InvoiceStore
from btn_electrum.util import profiler, InvalidPassword
from btn_electrum.plugins import run_hook
from btn_electrum.util import format_satoshis, format_satoshis_plain
from btn_electrum.paymentrequest import PR_UNPAID, PR_PAID, PR_UNKNOWN, PR_EXPIRED
...
Factory.register('TabbedCarousel', module='btn_electrum_gui.kivy.uix.screens')
...
from btn_electrum.util import base_units
...
class ElectrumWindow(App):
    ...
    def choose_server_dialog(self, popup):
        ...
        protocol = 's'
        def cb2(host):
            from btn_electrum.network import DEFAULT_PORTS
    ...
    def on_qr(self, data):
        from btn_electrum.bitcoin import base_decode, is_address
        data = data.strip()
        if is_address(data):
            self.set_URI(data)
            return
        ...
        from btn_electrum.transaction import Transaction
        from btn_electrum.util import bh2u
        try:
    ...
    def show_pr_details(self, req, status, is_invoice):
        from btn_electrum.util import format_time
    ...
    @profiler
    def init_ui(self):
        ''' Initialize The Ux part of btn_electrum. This function performs the basic
        ...
        Factory.register('AnimatedPopup',
                         module='btn_electrum_gui.kivy.uix.dialogs')
        Factory.register('QRCodeWidget',
                         module='btn_electrum_gui.kivy.uix.qrcodewidget')
    ...
    def notify(self, message):
        try:
            ...
            notification.notify('Electrum', message,
                                app_icon=icon, app_name='Btn Electrum')
        except ImportError:
