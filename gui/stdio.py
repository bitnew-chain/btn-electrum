...
from btn_electrum.util import format_satoshis, set_verbosity
from btn_electrum.bitcoin import is_address, COIN, TYPE_ADDRESS
...
class ElectrumGui:
    ...
    def __init__(self, config, daemon, plugins):
        ...
        if not storage.file_exists:
            print("Wallet not found. try 'btn-electrum create'")
            exit()
    ...
    def network_dialog(self):
        print("use 'btn-electrum setconfig server/proxy' to change your network settings")
        return True


    def settings_dialog(self):
        print("use 'btn-electrum setconfig' to change your settings")
        return True
