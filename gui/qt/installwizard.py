...
from btn_electrum import Wallet, WalletStorage
from btn_electrum.util import UserCancelled, InvalidPassword
from btn_electrum.base_wizard import BaseWizard, HWD_SETUP_DECRYPT_WALLET, GoBack
...
class InstallWizard(QDialog, MessageBoxMixin, BaseWizard):
    ...
    def __init__(self, config, app, plugins, storage):
        ...
        self.setWindowTitle('Btn Electrum  -  ' + _('Install Wizard'))
        self.app = app
        self.config = config
    ...
    def restore_seed_dialog(self, run_next, test):
        ...
        if 'mobile' == self.wallet_type:
            message = ''.join([
                ...
                _('This is compatible with btn mobile wallet. \n')])
        else:
            if self.opt_ext:
                options.append('ext')
            # if self.opt_bip39:
            ...
            message = ''.join([
                _('Please enter your seed phrase in order to restore your wallet. \n'),
                _('Btn Electrum is not compatiable with btn mobile wallet seed words yet. \n'),
                _('You cannot restore your mobile wallet in Btn Electrum for now.')])
