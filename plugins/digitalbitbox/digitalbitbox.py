...
try:
    import btn_electrum
    from btn_electrum.bitcoin import TYPE_ADDRESS, push_script, var_int, msg_magic, Hash, verify_message, \
    ...
    from btn_electrum.util import print_error
    from btn_electrum.base_wizard import ScriptTypeNotSupported, HWD_SETUP_NEW_WALLET
