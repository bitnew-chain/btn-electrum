...
from btn_electrum.btn import (b58_address_to_hash160, xpub_from_pubkey,
                                TYPE_ADDRESS, TYPE_SCRIPT, TESTNET, btn_addr_to_bitcoin_addr)
...
from btn_electrum.keystore import Hardware_KeyStore, is_xpubkey, parse_xpubkey
...
class TrezorPlugin(HW_PluginBase):
    ...
    def get_coin_name(self):
        return "Testnet" if TESTNET else "Btn"
