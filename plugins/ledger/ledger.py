...
from btn_electrum.bitcoin import TYPE_ADDRESS, int_to_hex, var_int, TYPE_SCRIPT
from btn_electrum.i18n import _
from btn_electrum.plugins import BasePlugin
from btn_electrum.keystore import Hardware_KeyStore
from btn_electrum.transaction import Transaction
from btn_electrum.wallet import Standard_Wallet
from ..hw_wallet import HW_PluginBase
from btn_electrum.util import print_error, bfh, bh2u, is_verbose, versiontuple
...
MSG_NEEDS_FW_UPDATE_SEGWIT = _('Firmware version (or "Btn" app) too old for Segwit support. Please update at') + \
                      ' https://www.ledgerwallet.com'
