...
class TestUtil(unittest.TestCase):
    ...
    def test_parse_URI_address_label(self):
        self._do_test_parse_URI('bitcoin:15mKKb2eos1hWa6tisdPwwDC1a5J1y9nma?label=btn-electrum%20test',
                                {'address': '15mKKb2eos1hWa6tisdPwwDC1a5J1y9nma', 'label': 'btn-electrum test'})

    def test_parse_URI_address_message(self):
        self._do_test_parse_URI('bitcoin:15mKKb2eos1hWa6tisdPwwDC1a5J1y9nma?message=btn-electrum%20test',
                                {'address': '15mKKb2eos1hWa6tisdPwwDC1a5J1y9nma', 'message': 'btn-electrum test',
                                 'memo': 'btn-electrum test'})
    ...
    def test_parse_URI_multiple_args(self):
        self._do_test_parse_URI(
            'bitcoin:15mKKb2eos1hWa6tisdPwwDC1a5J1y9nma?amount=0.00004&label=btn-electrum-test&message=btn-electrum%20test&test=none&r=http://domain.tld/page',
            {'address': '15mKKb2eos1hWa6tisdPwwDC1a5J1y9nma', 'amount': 4000, 'label': 'btn-electrum-test',
             'message': u'btn_electrum test', 'memo': u'btn_electrum test', 'r': 'http://domain.tld/page',
             'test': 'none'})
