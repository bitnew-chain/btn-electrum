...
class Test_SimpleConfig(unittest.TestCase):
    ...
    def setUp(self):
        ...
        # for development machines with btn_electrum installed :)
    ...
    def test_simple_config_system_config_ignored_if_portable(self):
        """If btn-electrum is started with the "portable" flag, system
...
"""
    ...
    def setUp(self):
        ...
        self.thefile = tempfile.mkstemp(suffix=".btn-electrum.test.conf")[1]
    ...
    def test_read_system_config_file_does_not_exist(self):
        somefile = "/foo/I/do/not/exist/btn-electrum.conf"
